			...
			for(var i=0;i<cant;i++){
				...
				if(i%2==0){	
					...
					if(qresp!=null){
						...
						if(candTxt.length>1){
							candTxt = "<button type=button class='detalleButton"+canInd+"' style='margin-top:4px;border:none' onclick='showDetalle("+canInd+",1)'>+</button><div class=detalle"+canInd+" style='display:none;'>"+candTxt+"</div>";
						}
